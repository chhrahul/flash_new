  ...
  //window.open(filePath,'_system', 'location=yes'); 
	cordova.plugins.fileOpener2.open(
		...
		error: function (e) {
               ...
               {  
                   ...
                   appAvailability.check(
                       ...
                       function() {  // Error callback
                           if(confirm("In order to view PDF documents, please install a PDF Reader."))
                           {
                               cordova.InAppBrowser.open('https://play.google.com/store/apps/details?id=com.adobe.reader', '_system');
                           }
                       }
                   );
               }
            ...
            if(fileMIMEType == 'application/msword' || fileMIMEType == 'application/vnd.openxmlformats-officedocument.wordprocessingml.document')
            {
